...
public sealed class GWorld {
    ...
    private static Queue<GameObject> erpatients;
    ...
    static GWorld() {
        ...
        erpatients = new Queue<GameObject>();
    ...
    public void AddERPatient(GameObject p)
    {

        // Add the patient to the patients Queue
        erpatients.Enqueue(p);
    }
    ...
    public GameObject RemoveERPatient()
    {
        ...
        if (erpatients.Count == 0) return null;
        return erpatients.Dequeue();
    }
